...
<div class="container">
    <div class="row">
        ...
        <div class="product border card  rounded  " >
            <img class="card-img-top " src="<?php echo e($us->image); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminNave', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-contract\resources\views/adminIndex.blade.php ENDPATH**/ ?>